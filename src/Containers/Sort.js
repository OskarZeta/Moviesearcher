...
class Sort extends Component {
  clickHandler (e) {
    if (this.props.name === 'sort') {
      ...
      //console.log(e.target.parentNode.parentNode.parentNode.parentNode.querySelectorAll('input[name=direction]:checked')[0].value);
      ...
      //console.log(e.target.parentNode.parentNode.parentNode.parentNode.parentNode.querySelectorAll('input[name=sort]:checked')[0].value);
      if (this.props.genresSelected.length > 0) {
